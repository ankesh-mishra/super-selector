...
const RULES_BY_TOURNAMENT = {
  'ABL 2026': {
    ...
    scoringRows: [
      ...
      { event: 'STRAIGHT_SET_WIN_BONUS', points: '+0.25', detail: 'Bonus when the game is won 2-0.' },
      { event: 'DOMINANT_SET_BONUS', points: '+0.25', detail: 'Per set won by margin >= 10.' },
      { event: 'UNDERDOG_WIN_LARGE', points: '+0.50', detail: 'Winner bid total <= 50% of loser.' },
      { event: 'UNDERDOG_WIN_SMALL', points: '+0.25', detail: 'Winner bid total <= 75% of loser (if large not triggered).' },
